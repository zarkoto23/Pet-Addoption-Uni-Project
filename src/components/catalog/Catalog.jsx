...
const visiblePets=pets.slice(startIdx, startIdx+visibleCount)
  return (
    <div className="fixed backdrop-blur-xs bottom-90 inset-x-0 w-full max-w-6xl mx-auto z-50 fade-in-up">
      ...
      <button onClick={handlePrev} className="absolute -left-6 top-1/2 -translate-y-1/2 bg-white text-indigo font-bold text-xl h-16 w-10 rounded-full shadow-xl flex items-center justify-center hover:scale-110 transition">
        ‹
      </button>
