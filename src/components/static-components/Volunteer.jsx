  ...
  return (
    <div className="fixed top-40 left-1/2 transform -translate-x-1/2 flex-col items-center justify-start p-4">
      <div className="text-center mb-6 max-w-3xl">
        ...
        >
          Join our amazing team of volunteers who help rescue, care for, and
          find loving homes for animals in need. Your kindness and time can
        ...
        >
          ...
          <p className="text-base text-gray-700 mb-5">
            Volunteering is a rewarding way to give back and support animals who
            need love, care, and attention. You'll join a compassionate
            community working toward the same mission.
          </p>
          ...
          <p className="text-base text-gray-700 mb-5">
            Volunteers help with daily care, feeding, socializing pets,
            organizing events, transport, home checks, and more. No experience
            required — just a big heart.
          </p>
          ...
          <p className="text-base text-gray-700">
            ...
            We’ll guide you through the steps and provide all necessary
            training.
          </p>
        </div>
      </div>
